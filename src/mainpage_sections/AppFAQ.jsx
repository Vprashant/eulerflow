          ...
          <div className="w-full px-4 lg:w-1/2">
            <div className="mb-12 flex lg:mb-[70px]">
              ...
              <div className="w-full">
                ...
                Eulerflow is an AI-based no-code solution. It has capabilities to design and publish applications for Generative AI document-based Q&A and for video and image analytics pipelines.
                </p>
              </div>
            </div>
            <div className="mb-12 flex lg:mb-[70px]">
              ...
              <div className="w-full">
                <h3
                  className="mb-6 text-xl font-semibold text-dark dark:text-white sm:text-2xl lg:text-xl xl:text-2xl"
                >
                  What kind of pipelines can I create with Eulerflow?
                </h3>
                <p className="text-base text-body-color dark:text-dark-6">
                Eulerflow allows you to create media pipelines and RAG-based (Retrieval-Augmented Generation) as well as prompt-based pipelines. This versatility makes it suitable for a wide range of AI applications.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="mb-12 flex lg:mb-[70px]">
              ...
              <div className="w-full">
                <h3
                  className="mb-6 text-xl font-semibold text-dark dark:text-white sm:text-2xl lg:text-xl xl:text-2xl"
                >
                  Is Eulerflow easy to use?
                </h3>
                <p className="text-base text-body-color dark:text-dark-6">
                Yes, Eulerflow is designed to be user-friendly. Being a no-code solution, it enables users without technical expertise to design and deploy AI applications efficiently.
                </p>
              </div>
            </div>
            <div className="mb-12 flex lg:mb-[70px]">
              ...
              <div className="w-full">
                <h3
                  className="mb-6 text-xl font-semibold text-dark dark:text-white sm:text-2xl lg:text-xl xl:text-2xl"
                >
                  Can Eulerflow handle video and image analytics?
                </h3>
                <p className="text-base text-body-color dark:text-dark-6">
                Absolutely. Eulerflow has operators specifically designed for video and image analytics, allowing you to build and deploy powerful media processing pipelines.
                </p>
              </div>
            </div>
          </div>
