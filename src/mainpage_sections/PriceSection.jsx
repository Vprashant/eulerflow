        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4">
            <div className="mx-auto mb-[60px] max-w-[510px] text-center">
              ...
              Choose from a variety of pricing plans tailored to meet your needs. Experience the best value without compromise.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            ...
            >
              ...
              >
                ...
                <span className="-ml-1 -tracking-[2px]">Free</span>
                <span
