            ...
            <div className="mb-10 w-full">
              ...
              <ul>
                <li>
                  <a
                    href="javascript:void(0)"
                    className="mb-3 inline-block text-white text-gray-7 hover:text-gray-400"
                  >
                    Home
                  </a>
                </li>
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-2/3 lg:w-1/2">
              <div className="my-1">
                ...
                >
                  <a
                    href="javascript:void(0)"
                    className="px-3 text-white text-gray-7 hover:text-white hover:underline"
                  >
                    Privacy policy
                  </a>
                  <a
            ...
            <div className="w-full px-4 md:w-1/3 lg:w-1/2">
              <div className="my-1 flex justify-center md:justify-end">
                <p className="text-white text-gray-7">
                  Eulerflow
